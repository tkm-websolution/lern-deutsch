		...
		<div class="w3-row">
			<div class="w3-panel w3-border-top w3-border-bottom w3-xlarge">
			 ...
			 <div class="w3-card-4 w3-padding-48">
				...
				<div id="spanBox" class="w3-container">
					<span id="das">
						<button class="w3-hide w3-btn w3-white w3-border w3-border-grey w3-round w3-xxlarge w3-margin-bottom">
							das
						</button>
					</span>
					<span id="der">
				...
				<div id="nomenBox" class="w3-container w3-padding-64">
				  	<?php foreach ($res as $val) : ?>
				  		<?php if($val["genus"] != 4) :?>
						<button class="w3-btn w3-white w3-border w3-border-grey w3-round w3-xxlarge w3-margin-bottom words" 
						data-genus='<?= $val["genus"] ?>'>
							<?= $val["meaning"] ?>
						</button>
					<?php endif; ?>
					<?php endforeach; ?>
